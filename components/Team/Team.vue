	...
	<section class="bg-hakooi">
		<div class="mx-auto container">
			<div class="w-full flex flex-col p-6 text-white">
				...
				>We are a small team whom focus on creating better problem solving while strive to perfecting our craft in web development industry especially on custom handcrafted ruby on rails</p>
				<div class="container flex flex-wrap flex-row py-12">
					...
					<div class="team-card md:w-1/2">
						...
						<h3 class="text-4xl text-white font-bold leading-none mt-12">Alfian jauhari</h3>
