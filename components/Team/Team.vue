<template>
	<section class="bg-hakooi">
		<div class="mx-auto container">
			<div class="w-full flex flex-col p-6 text-white">
				<p
				...
				<div class="container flex flex-wrap flex-row py-12">
					<div class="team-card md:w-1/2">
						<picture>
							<img class="w-full object-contain" alt="hakooi-logo" src="~/assets/images/komeng.jpeg" />
						</picture>
						<h3 class="text-4xl text-white font-bold leading-none mt-12">muhammad kurnia</h3>
					...
					<div class="team-card md:w-1/2">
						...
						<h3 class="text-4xl text-white font-bold leading-none mt-12">Alfian</h3>
						<h4 class="text-3xl text-white font-bold leading-none mt-6">Creative director</h4>
						<p
							class="my-6"
						>A creative director is a professional in the field of project management. Project managers have the responsibility of the planning, procurement and execution of a project, in any undertaking that has a defined scope, defined start and a defined finish; regardless of industry. Project managers are first point of contact for any issues or discrepancies arising from within the heads of various departments in an organization before the problem escalates to higher authorities.</p>
					</div>
				</div>
			</div>
		</div>
